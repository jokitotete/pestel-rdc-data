...
const ICONS = {
  ...
  telecoms: `<svg viewBox="0 0 24 24" fill="none"><path d="M12 11 L9.6 20.5 H14.4 Z" fill="__F__" fill-opacity="0.2" ${S} stroke-width="1.5" stroke-linejoin="round"/><circle cx="12" cy="8.8" r="2" fill="__F__" fill-opacity="0.2" ${S} stroke-width="1.5"/><path d="M7.2 4.2 A7 7 0 0 0 7.2 13.4 M16.8 4.2 A7 7 0 0 1 16.8 13.4" ${S} stroke-width="1.4" stroke-linecap="round"/></svg>`,
  ...
  warning: `<svg viewBox="0 0 24 24" fill="none"><path d="M12 3.6 L21.5 20 H2.5 Z" fill="__F__" fill-opacity="0.2" ${S} stroke-width="1.7" stroke-linejoin="round"/><path d="M12 9.6 V14 M12 16.8 V17.1" ${S} stroke-width="1.8" stroke-linecap="round"/></svg>`,
  'map-pin': `<svg viewBox="0 0 24 24" fill="none"><path d="M12 21 C12 21 19 14.5 19 9.5 A7 7 0 0 0 5 9.5 C5 14.5 12 21 12 21 Z" fill="__F__" fill-opacity="0.2" ${S} stroke-width="1.7" stroke-linejoin="round"/><circle cx="12" cy="9.5" r="2.4" ${S} stroke-width="1.6"/></svg>`,
